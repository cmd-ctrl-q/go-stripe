...
import (
	...
	"github.com/cmd-ctrl-q/go-stripe/internal/validator"
...
func (app *application) CreateCustomerAndSubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	// validate data
	v := validator.New()
	v.Check(len(data.FirstName) < 3, "first_name", "must be at least 2 characters")
	v.Check(data.LastName == "", "last_name", "must not be empty")
...
func (app *application) SendPasswordResetEmail(w http.ResponseWriter, r *http.Request) {
	...
	// send mail
	app.SendMail("info@widgets.com", payload.Email, "Password Reset Request", "password-reset", data)
	if err != nil {
		app.errorLog.Println(err)
		app.badRequest(w, r, err)
		return
...
func (app *application) AllSubscriptions(w http.ResponseWriter, r *http.Request) {
	...
	allSales, lastPage, totalRecords, err := app.DB.GetAllOrdersPaginated(payload.PageSize, payload.CurrentPage, 1)
	if err != nil {
		app.badRequest(w, r, err)
		return
	}
