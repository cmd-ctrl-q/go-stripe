...
// TransactionStatus is the type for order statuses
...
// If isRecurring is set to 0, returns all non-subscribed orders
// else if set to 1, returns the subscribed orders.
